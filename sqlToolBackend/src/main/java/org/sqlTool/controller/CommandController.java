...
/** @author Gunnel @Date: 2021/6/24 @Time: 10:59 PM @Description: */
@CrossOrigin
@Slf4j
@RestController
...
public class CommandController {
  ...
  @Resource MySqlToolBizService mySqlToolBizService;
  ...
  public BaseResponse explainPlan(@RequestBody QuerySqlCommandDto querySqlCommandDto)
      throws Exception {
